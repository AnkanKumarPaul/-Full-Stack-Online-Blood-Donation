...
import { faDroplet, faUserDoctor, faHome, faSearch, faUser, faHospitalUser, faTable, faArrowLeft, faArrowRight, faEnvelope, faPhone } from '@fortawesome/free-solid-svg-icons'
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
        ...
        <>
            <Router>
                <nav className="nav">
                    ...
                    <FontAwesomeIcon icon={faUserDoctor} className="doctoricon" /> <h5 className="h5">  Online Blood Donation  <FontAwesomeIcon icon={faDroplet} /> </h5>
